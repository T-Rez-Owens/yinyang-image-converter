...
def yin_yang_with_images(R=1.0, image1_path=None, image2_path=None, unify_method='brightness_match', 
                        img1_rotation=0, img2_rotation=0, 
    ...
    img1_rotation: Degrees to rotate image1 (default: 0)
    img2_rotation: Degrees to rotate image2 (default: 0) 
    ...
    if img1_rotation != 0:
        img1_resized = img1_resized.rotate(img1_rotation)
    ...
    if img2_rotation != 0:
        img2_resized = img2_resized.rotate(img2_rotation)
...
if __name__ == "__main__":
    ...
    print("=======================")
    print("This script creates a yin-yang using two different images!")
    print()
